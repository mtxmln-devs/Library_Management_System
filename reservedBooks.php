...
$sql = "SELECT r.ReservationID, r.ReservationDate, r.Status, b.BookID, b.Title, b.Author 
        FROM reservations r
        JOIN book b ON r.BookID = b.BookID 
        WHERE r.Status = 'Reserved' AND r.UserID = ?";
...
<head>
    ...
    <title>Library Management System - Reserve</title>
                ...
                <table class="books-table">
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='7' style='text-align:center;'>No borrowed books found.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
