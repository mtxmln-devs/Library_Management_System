...
$sql = "
    SELECT br.RecordID, br.BookID, b.Title, br.BorrowDate, br.DueDate, br.ReturnDate, br.Status
    FROM bookrecords br
...
$sqlUpdate = "UPDATE bookrecords 
              SET ReturnDate = CURDATE() 
              WHERE UserID = ? 
                AND Status = 'Returned' 
                AND (ReturnDate IS NULL OR ReturnDate = '0000-00-00')";
    ...
    <div class="main-content">
        ...
        <div class="borrowed-books-content">
            ...
            <table class="books-table">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="7" style="text-align: center;">No returned books found.</td>
                    </tr>
                <?php endif; ?>
                </tbody>
            </table>
