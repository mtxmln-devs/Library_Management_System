    ...
    if ($UserId <= 0 ||$bookId <= 0 || $quantity <= 0) {
        ...
        if ($stmt->fetch()) {
            if ($copiesAvailable >= $quantity) {
                ...
                $stmt = $conn->prepare("INSERT INTO BookRecords (UserID, BookID, BorrowDate, DueDate, Status) VALUES (?, ?, ?, ?, ?)");
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <div class="menu">
                ...
                <a href="borrowForm.php" class="menu-item active">
            ...
            <div class="reservation-content">
                <div class="reservation-form">
                    ...
                    <form method="post" action="">
                        ...
                        <button type="submit" class="reserve-button">BORROW</button>
                    </form>
                </div>
                ...
                <table class="books-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($row['CopiesAvailable']) ?></td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
